...
* From GTFOBINS we found that journalctl is using less to show the output so we can break from that to root shell if the output windows is smaller that 5 lines 
